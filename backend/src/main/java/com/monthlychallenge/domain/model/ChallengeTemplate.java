...
public final class ChallengeTemplate {
    ...
    private ChallengeTemplate(Builder b) {
        ...
        this.category = b.category; this.suggestedFrequency = b.suggestedFrequency;
    ...
    public ChallengeFrequency getSuggestedFrequency() { return suggestedFrequency; }
    public ChallengeTarget getSuggestedTarget()   { return suggestedTarget; }

    public static Builder builder() { return new Builder(); }

    public static final class Builder {
        private UUID id; private String title; private String description;
        private ChallengeCategory category; private ChallengeFrequency suggestedFrequency;
        ...
        public Builder suggestedFrequency(ChallengeFrequency v) { this.suggestedFrequency = v; return this; }
        public Builder suggestedTarget(ChallengeTarget v)  { this.suggestedTarget = v; return this; }
        public ChallengeTemplate build()                   { return new ChallengeTemplate(this); }
    }
}
